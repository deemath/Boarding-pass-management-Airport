    ...
    <div class="page">
        ...
        <main class="content">
            <div class="container">
                ...
                <br>
                <form action="./user_create_run.php" method="post" id="create_user">
                        ...
                        <div class="row p-1">
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control border border-black " id="name" name="name">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control border border-black " id="displayName" name="displayName">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <input type="email" class="form-control border border-black " id="email" name="email">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control border border-black " id="tele" name="tele">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="mb-1">
