...
<div class="row mb-3">
    <label for="from_city_code" class="col-sm-2 col-form-label">From City Airport Code</label>
    <div class="col-sm-10">
...
<div class="row mb-3">
    <label for="to_city_code" class="col-sm-2 col-form-label">To City Airport Code</label>
    <div class="col-sm-10">
...
<div class="row mb-3">
    <label for="date_of_flight" class="col-sm-2 col-form-label">Date of Flight</label>
    <div class="col-sm-10">
...
<div class="row mb-3">
    <label for="no_of_iv" class="col-sm-2 col-form-label">NO of IV</label>
    <div class="col-sm-10">
...
<div class="row mb-3">
    <label for="no_of_pax" class="col-sm-2 col-form-label">NO of pax</label>
    <div class="col-sm-10">
