    ...
    <main class="content">
        <div class="container mt-4">
            <div style="display: flex; justify-content: space-between">
                <h2><b><?php echo htmlspecialchars($airlineName); ?> - ALL Details</b></h2>
                <div>
                    <?php
                    ...
                    <!-- Trigger Button -->
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#email_loung_am">
                        Send Mail Lounge.am
                    </button>

                    <!-- <a href="generate_all_passengers_airline_pdf.php?airline=<?php echo htmlspecialchars($airline); ?>&airlineName=<?php echo htmlspecialchars($airlineName); ?>" -->
            ...
            if (isset($result) && $result->num_rows > 0) {
                ...
                <th class='text-center align-middle'>Seat Number</th>
                <th class='text-center align-middle'>Type</th>
                <th class='text-center align-middle'>No of iv</th>
                <th class='text-center align-middle'>No of pax</th>
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    if (($_SESSION['USER_TYPE'] == 'Admin') || ($_SESSION['USER_TYPE'] == 'User' && $row["captured_date"] == $dateFromDefault)): ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body">
                    <form method="POST" id="emailForm" action="./email_loung_am.php" enctype="multipart/form-data">
                        <input type="file" id="airline_report_lm" class="form-control mb-2" name="airline_report_lm" required>
                        <input type="email" id="email" name="email" v class="form-control mb-2" placeholder="Enter recipient email" required>
                        <input type='hidden' name='subject' value='<?php echo $subject; ?>'>
                        <button class="btn btn-primary mb-2" id="send_mail_LM" type="submit">Send Mail Lounge.am</button>
                    </form>
                </div>
    ...
    <script>
        ...
        new DataTable('#example', {
            ...
            buttons: [{
                ...
                columns: ':visible',
                columns: [0, 1, 3, 4], // Specify column indices to include (0-based index)
                ...
                customize: function(doc) {
                    ...
                    doc.content[1].table.body[0].forEach(cell => {
                        ...
                        cell.fontSize = 12; // Font size
                        cell.bold = true; // Font size
                        cell.border = [true, true, true, true]; // Add border on all sides
                    });
                    ...
                    doc.content.unshift({
                        stack: [{
                            ...
                            //         x1: 0,
                            //         y1: 0,
                            //         x2: 535, // Adjust width based on page width
                            //         y2: 0,
                            //         lineWidth: 1
                            //     }]
                            // }
                        ...
                        return {
                            stack: [
                                // First line: Copyright
                                {
                                    ...
                                    alignment: 'left',
                                    style: 'footerStyle1',
                                    margin: [10, 0, 0, 2] // Adjust bottom margin for spacing
                                },
                                // Second line: Powered by IT Division and page numbers
                                {
                                    columns: [{
                            ...
                            margin: [10, 0, 10, 10] // Adjust overall margin for the footer
                        };
                    };
            ...
            }, 'copy', 'csv', 'excel', 'print'] // Other buttons
        });
    </script>
    <!-- <script>
