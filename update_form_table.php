...
if (isset($_POST['update'])) {
    ...
    if ($conn->query($sql) === TRUE) {
        ...
        echo '<script>alert("Record updated successfully!"); window.location.href = "./full_report.php";</script>';
    } else {
                        ...
                        <form action="" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" maxlength="485" id="remarks" name="remarks"><?php echo htmlspecialchars($row['remarks']); ?></textarea>
